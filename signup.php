...
<form action = "" method= "post">
    <div class="wrapper">
        ...
        <form class="p-3 mt-3" method= "POST">
            <div class="form-field d-flex align-items-center"> <span class="far fa-user"></span> <input type="text" name="nama" id="name" placeholder="Nama"> </div>
            ...
            <button class="btn mt-3" name="signup" id="signup"> Sign In</button>
            <br>
            <div class="text-center fs-6"><p>Sudah punya akun? <a href="login.php" style="font-size: 17;"> Login</a></p>  </div>
        </form>
    </div>
</form>
